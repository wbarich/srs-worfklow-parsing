...
3. **Evaluation**: The graphs generated by the LLM are compared against the hand-annotations to determine the efficacy of the approach. The results are interrogated, and improvements are listed. Again Openai's text-embedding-ada-002 model is used for the embeddings.
